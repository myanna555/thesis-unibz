...
$blade_grve_social_list_extended = array (
	array(
		'title' => 'Twitter',
		'url' => 'twitter_url',
		'id' => 'twitter',
 ...
 */
function blade_grve_is_plugin_active( $plugin ) {
...
//add_filter( 'blade_grve_the_content', 'wpautop'                           );
add_filter( 'blade_grve_the_content', 'shortcode_unautop'                 );
add_filter( 'blade_grve_the_content', 'prepend_attachment'                );
add_filter( 'blade_grve_the_content', 'wp_make_content_images_responsive' );
